  ...
  //test connection to db
        ...
        try {
         ...
         //  $conn = mysqli_connect("localhost", "otptest", "root", "");
            ...
            $sql = "INSERT INTO globaltable (fname, lname, email, number, password1, date, ip, ballance, profit, bonus, plan, withdraw,country	,verification_code, verification_date) VALUES 
              ('" . $fname . "', '" . $lname . "', '" . $email. "', '". $number."','".$password1."','".$date."','".$ip ."','".$ballance."','".$profit ."','".$bonus."','".$plan."','".$withdraw ."','". $country."','" . $verification_code . "', NULL)";
...
<title>lexaprime| Your Trusted Bitcoin  Mining and Investment Company</title>
...
<link href="lexaprime2.png" rel="icon" type="image/x-icon" />
...
<meta property="og:site_name" content="lexaprime| Your Trusted Bitcoin  Mining and Investment Company">
...
<ul class="topheader">
	<li class="logo">
		<div class="bodycontainer">
			...
			<a href="index.html">
            <img src="lexaprime2.png"  style="width:100px;height:80px; border-top-left-radius:20px;border-bottom-right-radius:20px;" title="lexaprime| Your Trusted Bitcoin  Mining and Investment Company"/>
			</a>
		</div>
	</li>
	<li class="data">
...
<div class="form-group">
        ...
        <div class="col-12 col-m-12 col-sm-12"><input type="checkbox" name="agree" required checked> I agree to lexaprime| Your Trusted Bitcoin  Mining and Investment Company <a href="info/terms.html" target="_blank">Terms and conditions</a>
        </div>
        <div class="col-12 col-m-12 col-sm-12"><input type="checkbox" name="mail" required> I agree to receive lexaprime| Your Trusted Bitcoin  Mining and Investment Company emails</label>
        </div>
        <div class="col-12 col-m-12 col-sm-12">
        	<input type="submit" value="Submit" class="btn round default" name="register" style="border:0"><br><br>
...
<footer>
    <div class="bodycontainer">
        <div class="row">
            ...
            <div class="padding">
				...
				<a href="mailto://support@lexaprime.com"><h3>support@lexaprime.com</h3></a>
	...
	<hr>
	<p class="center">Copyright © 2024  lexaprime, All Rights Reserved</p>
    </div>
</footer>
